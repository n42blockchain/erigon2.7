...
func (m *MockSyncContributionPool) GetSyncAggregate(slot uint64, beaconBlockRoot libcommon.Hash) (*cltypes.SyncAggregate, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockSyncContributionPoolGetSyncAggregateCall) Do(f func(uint64, libcommon.Hash) (*cltypes.SyncAggregate, error)) *MockSyncContributionPoolGetSyncAggregateCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockSyncContributionPoolGetSyncAggregateCall) DoAndReturn(f func(uint64, libcommon.Hash) (*cltypes.SyncAggregate, error)) *MockSyncContributionPoolGetSyncAggregateCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// GetSyncContribution mocks base method.
func (m *MockSyncContributionPool) GetSyncContribution(slot, subcommitteeIndex uint64, beaconBlockRoot libcommon.Hash) *cltypes.Contribution {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockSyncContributionPoolGetSyncContributionCall) Do(f func(uint64, uint64, libcommon.Hash) *cltypes.Contribution) *MockSyncContributionPoolGetSyncContributionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockSyncContributionPoolGetSyncContributionCall) DoAndReturn(f func(uint64, uint64, libcommon.Hash) *cltypes.Contribution) *MockSyncContributionPoolGetSyncContributionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
