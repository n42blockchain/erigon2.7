...
var testValidator1 = solid.NewValidatorFromParameters(
	...
	libcommon.HexToHash("401ef8ad032de7a3b8a50ae67cd823b0944d2260cd0d018e710eebf8e832b021"),
...
var testValidator2 = solid.NewValidatorFromParameters(
	...
	libcommon.HexToHash("3ba9e58ab7d3807a2733e3aa204fdacde3f0d16e7126492c72fa228eae20c5eb"),
	4748534886993468932,
	false,
	9720109592954569431,
...
var testValidatorRoot1 = libcommon.HexToHash("83e755dbe8b552c628677bcad4d5f28b29f9a24bfe1b3db26f5386ad823a5a67")
var testValidatorRoot2 = libcommon.HexToHash("0bcf6f6b165f8ba4a0b59fad23195a83097cdfc62eca06d6219d5699f057aa14")
...
func TestValidatorSlashed(t *testing.T) {
	...
	require.Equal(t, libcommon.Hash(root), testValidatorRoot1)
}
...
func TestValidatorNonSlashed(t *testing.T) {
	...
	root, err := decodedValidator.HashSSZ()
	require.NoError(t, err)
	require.Equal(t, libcommon.Hash(root), testValidatorRoot2)
