...
func (m *MockBeaconStateReader) GenesisValidatorsRoot() libcommon.Hash {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockBeaconStateReaderGenesisValidatorsRootCall) Return(arg0 libcommon.Hash) *MockBeaconStateReaderGenesisValidatorsRootCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockBeaconStateReaderGenesisValidatorsRootCall) Do(f func() libcommon.Hash) *MockBeaconStateReaderGenesisValidatorsRootCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockBeaconStateReaderGenesisValidatorsRootCall) DoAndReturn(f func() libcommon.Hash) *MockBeaconStateReaderGenesisValidatorsRootCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockBeaconStateReader) ValidatorPublicKey(index int) (libcommon.Bytes48, error) {
	m.ctrl.T.Helper()
