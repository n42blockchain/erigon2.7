...
type Impl struct {
	...
	FnProcessBlockHeader          func(s abstract.BeaconState, slot, proposerIndex uint64, parentRoot libcommon.Hash, bodyRoot [32]byte) error
	FnProcessWithdrawals          func(s abstract.BeaconState, withdrawals *solid.ListSSZ[*cltypes.Withdrawal]) error
	FnProcessExecutionPayload     func(s abstract.BeaconState, parentHash, prevRandao libcommon.Hash, time uint64, payloadHeader *cltypes.Eth1Header) error
...
func (i Impl) ProcessBlockHeader(s abstract.BeaconState, slot, proposerIndex uint64, parentRoot libcommon.Hash, bodyRoot [32]byte) error {
...
func (i Impl) ProcessExecutionPayload(s abstract.BeaconState, parentHash, prevRandao libcommon.Hash, time uint64, payloadHeader *cltypes.Eth1Header) error {
