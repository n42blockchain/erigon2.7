...
func (m *MockAggregationPool) GetAggregatationByRoot(root libcommon.Hash) *solid.Attestation {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockAggregationPoolGetAggregatationByRootCall) Do(f func(libcommon.Hash) *solid.Attestation) *MockAggregationPoolGetAggregatationByRootCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockAggregationPoolGetAggregatationByRootCall) DoAndReturn(f func(libcommon.Hash) *solid.Attestation) *MockAggregationPoolGetAggregatationByRootCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// GetAggregatationByRootAndCommittee mocks base method.
func (m *MockAggregationPool) GetAggregatationByRootAndCommittee(root libcommon.Hash, committeeIndex uint64) *solid.Attestation {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockAggregationPoolGetAggregatationByRootAndCommitteeCall) Do(f func(libcommon.Hash, uint64) *solid.Attestation) *MockAggregationPoolGetAggregatationByRootAndCommitteeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockAggregationPoolGetAggregatationByRootAndCommitteeCall) DoAndReturn(f func(libcommon.Hash, uint64) *solid.Attestation) *MockAggregationPoolGetAggregatationByRootAndCommitteeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
