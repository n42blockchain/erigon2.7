...
type AggregationPool interface {
	...
	GetAggregatationByRoot(root libcommon.Hash) *solid.Attestation
	GetAggregatationByRootAndCommittee(root libcommon.Hash, committeeIndex uint64) *solid.Attestation
}
