...
type DataColumnStorage interface {
	WriteColumnSidecars(ctx context.Context, blockRoot libcommon.Hash, columnIndex int64, columnData *cltypes.DataColumnSidecar) error
	RemoveColumnSidecars(ctx context.Context, slot uint64, blockRoot libcommon.Hash, columnIndices ...int64) error
	RemoveAllColumnSidecars(ctx context.Context, slot uint64, blockRoot libcommon.Hash) error
	ReadColumnSidecarByColumnIndex(ctx context.Context, slot uint64, blockRoot libcommon.Hash, columnIndex int64) (*cltypes.DataColumnSidecar, error)
	ColumnSidecarExists(ctx context.Context, slot uint64, blockRoot libcommon.Hash, columnIndex int64) (bool, error)
	WriteStream(w io.Writer, slot uint64, blockRoot libcommon.Hash, idx uint64) error // Used for P2P networking
	GetSavedColumnIndex(ctx context.Context, slot uint64, blockRoot libcommon.Hash) ([]uint64, error)
...
func dataColumnFilePath(slot uint64, blockRoot libcommon.Hash, columnIndex uint64) (dir, filepath string) {
...
func (s *dataColumnStorageImpl) WriteColumnSidecars(ctx context.Context, blockRoot libcommon.Hash, columnIndex int64, columnData *cltypes.DataColumnSidecar) error {
...
func (s *dataColumnStorageImpl) ReadColumnSidecarByColumnIndex(ctx context.Context, slot uint64, blockRoot libcommon.Hash, columnIndex int64) (*cltypes.DataColumnSidecar, error) {
...
func (s *dataColumnStorageImpl) ColumnSidecarExists(ctx context.Context, slot uint64, blockRoot libcommon.Hash, columnIndex int64) (bool, error) {
	lock := s.acquireLock(slot)
	lock.RLock()
	defer lock.RUnlock()
	_, filepath := dataColumnFilePath(slot, blockRoot, uint64(columnIndex))
...
func (s *dataColumnStorageImpl) RemoveAllColumnSidecars(ctx context.Context, slot uint64, blockRoot libcommon.Hash) error {
	lock := s.acquireLock(slot)
	lock.Lock()
	defer lock.Unlock()
...
func (s *dataColumnStorageImpl) RemoveColumnSidecars(ctx context.Context, slot uint64, blockRoot libcommon.Hash, columnIndices ...int64) error {
	lock := s.acquireLock(slot)
	lock.Lock()
	defer lock.Unlock()
...
func (s *dataColumnStorageImpl) WriteStream(w io.Writer, slot uint64, blockRoot libcommon.Hash, idx uint64) error {
	lock := s.acquireLock(slot)
	lock.RLock()
	defer lock.RUnlock()
...
func (s *dataColumnStorageImpl) GetSavedColumnIndex(ctx context.Context, slot uint64, blockRoot libcommon.Hash) ([]uint64, error) {
	lock := s.acquireLock(slot)
	lock.RLock()
	defer lock.RUnlock()
