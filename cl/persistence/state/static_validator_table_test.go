...
func TestStaticValidatorTable(t *testing.T) {
	...
	require.NoError(t, table.AddWithdrawalCredentials(1, 32, libcommon.HexToHash("0x2")))
	require.NoError(t, table.AddWithdrawalCredentials(1, 38, libcommon.HexToHash("0x3")))
	require.NoError(t, table.AddWithdrawalCredentials(1, 2000, libcommon.HexToHash("0x40")))
	require.Equal(t, libcommon.Hash{}, table.WithdrawalCredentials(1, 31))
	require.Equal(t, table.WithdrawalCredentials(1, 32), libcommon.HexToHash("0x2"))
	require.Equal(t, table.WithdrawalCredentials(1, 37), libcommon.HexToHash("0x2"))
	require.Equal(t, table.WithdrawalCredentials(1, 38), libcommon.HexToHash("0x3"))
	require.Equal(t, table.WithdrawalCredentials(1, 450), libcommon.HexToHash("0x3"))
	require.Equal(t, table.WithdrawalCredentials(1, 1_000_000), libcommon.HexToHash("0x40"))
	...
	require.Equal(t, new.WithdrawalCredentials(), libcommon.HexToHash("0x3"))
