...
func TestHashTreeRoot(t *testing.T) {
	...
	require.Equal(t, libcommon.Hash(root), libcommon.HexToHash("0x9f684cf34c4ac8eb9056051f93498c552b59de6b0977c453ee099be68e58d90c"))
}
...
func TestHashTreeRootTxs(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, libcommon.Hash(root), libcommon.HexToHash("0x987269bc1075122edff32bfc38479757103cee5c1ed6e990de7ffee85b5dd18a"))
}
