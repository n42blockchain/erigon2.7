...
func (b *BeaconState) baseOffsetSSZ() uint32 {
	...
	case clparams.ElectraVersion:
		// Electra has additional fields for consolidation requests and pending deposits
		return 2736661
	default:
		// ?????
		panic("tf is that")
...
func (b *BeaconState) getSchema() []interface{} {
	...
	if b.version >= clparams.ElectraVersion {
		s = append(s, &b.depositRequestsStartIndex, &b.depositBalanceToConsume, &b.exitBalanceToConsume,
			&b.earliestExitEpoch, &b.consolidationBalanceToConsume, &b.earliestConsolidationEpoch,
			b.pendingDeposits, b.pendingPartialWithdrawals, b.pendingConsolidations)
	}
	return s
}
