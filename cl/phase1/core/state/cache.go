...
type CachingBeaconState struct {
	...
	*raw.BeaconState
	...
	shuffledSetsCache     *lru.Cache[libcommon.Hash, []uint64]
...
func (b *CachingBeaconState) initCaches() error {
	...
	if b.shuffledSetsCache, err = lru.New[libcommon.Hash, []uint64]("beacon_shuffled_sets_cache", shuffledSetsCacheSize); err != nil {
		return err
	}
