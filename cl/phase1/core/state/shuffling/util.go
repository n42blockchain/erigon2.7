...
func GetSeed(beaconConfig *clparams.BeaconChainConfig, mix libcommon.Hash, epoch uint64, domain [4]byte) libcommon.Hash {
...
func ComputeShuffledIndicies(beaconConfig *clparams.BeaconChainConfig, mix libcommon.Hash, out, indicies []uint64, slot uint64) []uint64 {
	copy(out, indicies)
