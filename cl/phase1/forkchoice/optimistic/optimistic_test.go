...
var (
	...
	mockBlock1 = &cltypes.BeaconBlock{
		StateRoot:  libcommon.Hash{1},
		ParentRoot: libcommon.Hash{0},
	...
	mockBlock2 = &cltypes.BeaconBlock{
		StateRoot:  libcommon.Hash{2},
		ParentRoot: libcommon.Hash{1},
		Body: &cltypes.BeaconBody{
			ExecutionPayload: &cltypes.Eth1Block{
				BlockNumber: 2,
			},
	...
	mockBlock3_1 = &cltypes.BeaconBlock{
		StateRoot:  libcommon.Hash{3},
		ParentRoot: libcommon.Hash{2},
		Body: &cltypes.BeaconBody{
			ExecutionPayload: &cltypes.Eth1Block{
				BlockNumber: 3,
			},
...
func (t *optimisticTestSuite) TestAddOptimisticCandidate() {
	...
	t.Require().Equal(&opNode{
		execBlockNum: 1,
		parent:       libcommon.Hash{0},
		children:     []libcommon.Hash{{2}},
	}, node)
