...
func (m *MockExecutionEngine) ForkChoiceUpdate(ctx context.Context, finalized, safe, head libcommon.Hash, attributes *engine_types.PayloadAttributes) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockExecutionEngine) GetBlobs(ctx context.Context, versionedHashes []libcommon.Hash) ([][]byte, [][][]byte) {
	m.ctrl.T.Helper()
...
func (m *MockExecutionEngine) GetBodiesByHashes(ctx context.Context, hashes []libcommon.Hash) ([]*types.RawBody, error) {
	m.ctrl.T.Helper()
...
func (m *MockExecutionEngine) HasBlock(ctx context.Context, hash libcommon.Hash) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockExecutionEngine) IsCanonicalHash(ctx context.Context, hash libcommon.Hash) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockExecutionEngine) NewPayload(ctx context.Context, payload *cltypes.Eth1Block, beaconParentRoot *libcommon.Hash, versionedHashes []libcommon.Hash, executionRequestsList []hexutil.Bytes) (PayloadStatus, error) {
	m.ctrl.T.Helper()
