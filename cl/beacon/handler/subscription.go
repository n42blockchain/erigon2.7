...
func parseSyncCommitteeContribution(r *http.Request) (slot, subcommitteeIndex uint64, beaconBlockRoot libcommon.Hash, err error) {
	...
	beaconBlockRoot = libcommon.HexToHash(blockRootStr)
	return
}
