...
type SyncedData interface {
	...
	ValidatorPublicKeyByIndex(index int) (libcommon.Bytes48, error)
	ValidatorIndexByPublicKey(pubkey libcommon.Bytes48) (uint64, bool, error)
	HistoricalRootElementAtIndex(index int) (libcommon.Hash, error)
