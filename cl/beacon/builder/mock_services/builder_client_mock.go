...
func (m *MockBuilderClient) GetHeader(ctx context.Context, slot int64, parentHash libcommon.Hash, pubKey libcommon.Bytes48) (*builder.ExecutionHeader, error) {
	m.ctrl.T.Helper()
...
func (c *MockBuilderClientGetHeaderCall) Do(f func(context.Context, int64, libcommon.Hash, libcommon.Bytes48) (*builder.ExecutionHeader, error)) *MockBuilderClientGetHeaderCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockBuilderClientGetHeaderCall) DoAndReturn(f func(context.Context, int64, libcommon.Hash, libcommon.Bytes48) (*builder.ExecutionHeader, error)) *MockBuilderClientGetHeaderCall {
